    ...
    <footer className="relative bg-black">
      ...
      <div className="relative w-full h-[340px] md:h-[420px] overflow-hidden">
        <img
          ...
          alt="Framed Stikky posters displayed on a wall"
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-12 lg:gap-8">
            ...
            <div className="col-span-2">
              <a href="/" className="inline-flex items-center gap-2 mb-6">
                <span className="text-2xl font-display text-white">STIKKY</span>
              </a>

              <p className="text-white/50 leading-relaxed mb-8 max-w-xs text-sm">
                Museum-quality framed posters and stickers for the things you actually care about.
              </p>
        ...
        <div className="py-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-white/30">
            &copy; 2026 Stikky. All rights reserved.
          </p>

          <div className="flex items-center gap-4 text-sm text-white/30">
            <span className="flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-stikky-orange" />
              Fast delivery across Tunisia
            </span>
          </div>
        </div>
      </div>
