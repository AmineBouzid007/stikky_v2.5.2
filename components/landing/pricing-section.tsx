...
const plans = [
  {
    name: "Mini",
    description: "13 × 18 cm — perfect for small spaces & gifts",
  ...
  {
    name: "A4",
    description: "21 × 29.7 cm — a clean minimalist size",
    price: { monthly: 29, annual: 29 },
    features: [
      "Premium matte print",
      "High-quality paper",
      "Fits bedrooms & workspaces",
      "Ships in 4-6 business days",
    ],
    cta: "Shop A4",
    highlight: false,
  ...
  {
    name: "Medium",
    description: "30 × 50 cm — the perfect wall balance",
    price: { monthly: 50, annual: 50 },
    features: [
      "Premium matte print",
  ...
  {
    name: "Large",
    description: "40 × 60 cm — for bigger wall spaces",
    price: { monthly: 75, annual: 75 },
    features: [
      "Premium matte print",
      "Optional black frame",
  ...
  {
    name: "XL",
    description: "50 × 70 cm — the ultimate statement piece",
    price: { monthly: 90, annual: 90 },
    features: [
      "Premium matte print",
      "Optional black frame",
      "Best for living rooms & large walls",
      "Ships in 4-6 business days",
    ],
    cta: "Shop XL",
    highlight: false,
