...
const features = [
  {
    ...
    description: "Archival 200gsm matte paper and fade-resistant inks. Every piece is printed to hold its color for years, not months.",
    stats: { value: "200gsm", label: "archival paper" },
  },
  {
    number: "02",
    title: "Framed & Ready to Hang",
    description: "No trips to the frame shop. Every poster ships in a solid frame with hanging hardware already attached.",
    stats: { value: "0", label: "assembly required" },
  },
  {
    number: "03",
    title: "Fully Custom Pieces",
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-end">
            ...
            <div className="lg:col-span-5 lg:pb-4">
              <p className={`text-xl text-muted-foreground leading-relaxed transition-all duration-1000 delay-200 ${
                ...
                Every poster and sticker is designed like art, not a printout — and printed to a standard that actually holds up on your wall.
              </p>
            </div>
          </div>
        </div>
