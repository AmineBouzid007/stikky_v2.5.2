...
const steps = [
  {
    ...
    title: "Pick",
    subtitle: "your piece",
    description: "Browse cars, anime, football, movies, and gaming — or start a fully custom design from your own photo or idea.",
  ...
  },
  {
    ...
    title: "Choose",
    subtitle: "your size",
    description: "Select a size and frame finish. Custom orders get a design proof to approve before anything is printed.",
  ...
  },
  {
    ...
    title: "Track",
    subtitle: "& receive",
    description: "We print, frame, and ship with tracking, so you know exactly when it lands and is ready to hang.",
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-white/30">Print.</span>
              <span className="block text-white/10">Hang.</span>
            </h2>
          </div>
